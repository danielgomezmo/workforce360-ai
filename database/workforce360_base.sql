-- Workforce360 AI - Base de datos inicial
-- Base v1: estructura preparada para desarrollo incremental.
...
('Tecnología', 'Área de ejemplo para la base inicial'),
('Recursos Humanos', 'Área de ejemplo para la base inicial');
...
SELECT 'Workforce360 AI - Base v1 instalada correctamente' AS resultado;
